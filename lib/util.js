...
function findNewLineInDirectionFactory(direction) {
    var fn;
    ...
    return function (node) {
        ...
        node[fn](node.WHITE_SPACE_NODE, function (node) {
            if (/[\n\r]/.test(node)) {
                lineBreak = node;
...
util.getPreviousLineBreak = findNewLineInDirectionFactory('prev');
util.getNextLineBreak = findNewLineInDirectionFactory('next');
